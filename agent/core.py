    ...
    def run(self, user_message: str, verbose: bool = True) -> str:
        ...
        for round_num in range(1, self.max_rounds + 1):
            ...
            if message.tool_calls and len(message.tool_calls) > 0:
                ...
                self._log_interaction(round_num, "act", f"Calling {tool_name}({arguments})")
                ...
                self._log_interaction(round_num, "observe", 
                ...
                final_answer = message.content or "Sorry, I couldn't generate a response."
